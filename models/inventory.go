...
// Inventory Inventory contains inventory specific data
//
// swagger:model Inventory
type Inventory struct {

	// unit in stock
	UnitInStock int64 `json:"unit_in_stock,omitempty"`
...
func (m *Inventory) validateStatus(formats strfmt.Registry) error {
...
func (m *Inventory) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
