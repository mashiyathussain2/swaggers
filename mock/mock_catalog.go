...
func (m *MockKeeperCatalog) AddCatalogContent(arg0 *schema.AddCatalogContentOpts) (*schema.AddCatalogContentResp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddCatalogContent", arg0)
	ret0, _ := ret[0].(*schema.AddCatalogContentResp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
